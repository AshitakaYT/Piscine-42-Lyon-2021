...
/*   Updated: 2021/07/28 12:14:48 by aucousin         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_make_solution(struct s_map *str)
{
	...
	while (y < str->maxsize)
	{
		...
		while (x < str->maxsize)
		{
			str->mapchar[str->ymaxpos + y][str->xmaxpos + x] = str->fullfill;
			x++;
		}
		y++;
	}
...
int	ft_bsq(char *av)
{
	...
	ft_make_int_tab(str.mapint, str.mapchar, str.obstacle);
